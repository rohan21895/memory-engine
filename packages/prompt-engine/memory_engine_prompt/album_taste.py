...
_INSTRUCTION = (
    ...
    "of a place;\n"
    "  - the expressions on every visible face -- warm, genuine and flattering "
    "beats posed and stiff; nobody caught mid-blink, mid-speech or grimacing;\n"
    "  - which version makes its people look their best -- the pose, the "
    "angle and the framing that flatter them;\n"
    "  - variety of ELEMENTS across the set: outfits and dresses, backdrops "
    "and sets, props and signs, solo versus couple versus group framings -- "
    "two photographs that repeat the same outfit on the same set with the "
    "same prop should rarely both be picked;\n"
