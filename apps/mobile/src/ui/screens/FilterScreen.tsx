...
const styles = StyleSheet.create({
  ...
  chip: { backgroundColor: colors.panel, borderColor: colors.hairline, borderRadius: radii.pill, borderWidth: 1, minHeight: layout.minTouchTarget, justifyContent: "center", paddingHorizontal: spacing.md },
  ...
  segment: { alignItems: "center", borderRadius: 10, flex: 1, height: layout.minTouchTarget, justifyContent: "center" },
