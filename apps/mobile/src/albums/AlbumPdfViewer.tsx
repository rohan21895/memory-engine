...
const styles = StyleSheet.create({
  ...
  subtitle: { color: "rgba(255,255,255,.6)", fontFamily: fonts.regular, fontSize: 12, lineHeight: 17 },
  ...
  thumbnailLabel: { color: "rgba(255,255,255,.56)", fontFamily: fonts.medium, fontSize: 12, fontVariant: ["tabular-nums"] },
